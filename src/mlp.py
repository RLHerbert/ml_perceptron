...
class mlp:
    ...
    def _backprop(hidden_layer, output_layer, output_vector, target_vector, hidden_vector, attribute_vector, eta=0.1):
        ...
        output_responsibility = np.multiply(np.multiply(
            output_vector, (1 - output_vector)), (target_vector - output_vector))
        hidden_responsibility = np.multiply(np.multiply(
...
if __name__ == "__main__":
    ...
    forward_prop_results = _forward_prop(
    ...
    backprop_results = backpropagation(
